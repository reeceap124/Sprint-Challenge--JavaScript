...
graduates.forEach(function(grad){ //iterates over each grad and pushes their university to universities array
  universities.push(grad.university);
})
universities.sort(); //sorts the now populated university array
